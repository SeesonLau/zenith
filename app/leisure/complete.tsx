  ...
  return (
    ...
    >
      <View style={{ flex: 1, padding: 20 }}>
        {/* Header with Duration in Corner */}
        <View style={{ 
          flexDirection: 'row', 
          alignItems: 'center',
        ...
        >
          ...
          {/* Title Section */}
          <View style={{ marginBottom: 16 }}>
            <Text style={{ color: colors.textPrimary, fontWeight: '600', fontSize: 14, marginBottom: 6 }}>
              Title <Text style={{ color: colors.textTertiary, fontSize: 12 }}>(Optional)</Text>
            </Text>
            <TextInput
          ...
          <View style={{ marginBottom: 20 }}>
            <Text style={{ color: colors.textPrimary, fontWeight: '600', fontSize: 14, marginBottom: 6 }}>
              Notes <Text style={{ color: colors.textTertiary, fontSize: 12 }}>(Optional)</Text>
            </Text>
            <TextInput
